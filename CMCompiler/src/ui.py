...
#
# *所需文件*
#   - 语义分析器接口:sematic_uipai.py
#   - sematic_uipai.py所引用的特殊yacc文件:yacc_ui.py
#
# *功能*
#   - 语法正确，则显示词法分析结果，语法分析过程和三地址代码，汇编代码
#   - 语法错误，则显示出错类型和位置
#   - 文件错误，则提示文件不匹配
# 
# =============================================================================
# *实现思路*
#   1.构建主界面,出错界面和结果界面
#   2.在主界面中接受文件后将调用sematic_uipai.py进行词法，语法，语义分析
#   3.根据分析结果调用相应界面
# =============================================================================
...
class ResultWidget(QDialog):
    ...
    def initUI(self):
        ...
        leftlist.insertItem(3, '汇编结果')
        leftlist.setGeometry(20, 20, 90, 140)
